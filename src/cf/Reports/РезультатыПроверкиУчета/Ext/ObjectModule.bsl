...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ПараметрыФормы.Свойство("ДанныеКонтекста") Тогда
		...
		Если ТипЗнч(ПараметрыФормы.ДанныеКонтекста) = Тип("Структура") Тогда
			...
			Если ВыделенныеСтроки.Количество() > 0 Тогда
				//++Волкова закоментированно, т.к. при обновлении ругается на отсутствие КонтрольВеденияУчетаСлужебный
	...
	ИначеЕсли ПараметрыФормы.Свойство("ВидПроверки") Тогда
		//++Волкова закомментированно, т.к. нет такого модуля КонтрольВеденияУчетаСлужебный, КонтрольВеденияУчета
...
Функция ПодсказкаОПоследнейПроверке()
	//++Волкова нет такого модуля КонтрольВеденияУчетаСлужебный
