...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.РегистрацияВремени);
	СписокОбъектов.Добавить(Документы.Задача);
	СписокОбъектов.Добавить(Документы.ЛистТребований);
	СписокОбъектов.Добавить(Документы.ОплатаЧасов);
	СписокОбъектов.Добавить(Документы.ФинансоваяОперация);
	СписокОбъектов.Добавить(Документы.ЗакрытиеРабот);
	СписокОбъектов.Добавить(Документы.Подписка);
	СписокОбъектов.Добавить(Документы.ЕжедневныйОтчет);
	СписокОбъектов.Добавить(Документы.Договор);
	СписокОбъектов.Добавить(Справочники.итк_Задача);
