...
Процедура Игнорировать(Знач ВыделенныеСтроки, Пропустить, ИмяЭлемента)
	...
	Для Каждого ВыделеннаяСтрока Из ВыделенныеСтроки Цикл
		...
		РегистрыСведений._РезультатыОбменаДанными.Игнорировать(ВыделеннаяСтрока.ПроблемныйОбъект, ВыделеннаяСтрока.ТипПроблемы, Пропустить);
...
Функция КоличествоНезаполненныхРеквизитов()
	...
	ПараметрыПоиска = РегистрыСведений._РезультатыОбменаДанными.ПараметрыПоискаПроблем();
	...
	Возврат РегистрыСведений._РезультатыОбменаДанными.КоличествоПроблем(ПараметрыПоиска);
