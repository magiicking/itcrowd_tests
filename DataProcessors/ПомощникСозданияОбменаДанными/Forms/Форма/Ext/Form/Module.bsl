...
Функция СоздатьЗапросНаИспользованиеВнешнихРесурсов(Знач Объект, ЗапрашиватьCOM,
	...
	Запись = РегистрыСведений.УдалитьНастройкиТранспортаОбмена.СоздатьМенеджерЗаписи();
	ЗаполнитьЗначенияСвойств(Запись, Объект);
	Запись.Узел = Объект.СсылкаНового;
	
	ЗапросыРазрешений = Новый Массив;
	
	ПараметрыЗапроса = РегистрыСведений.УдалитьНастройкиТранспортаОбмена.ПараметрыЗапросаНаИспользованиеВнешнихРесурсов();
	...
	РегистрыСведений.УдалитьНастройкиТранспортаОбмена.ЗапросНаИспользованиеВнешнихРесурсов(ЗапросыРазрешений,
...
Функция ПолучитьОписаниеНастроекТранспортаОбмена()
	...
	ПредставленияНастроек = РегистрыСведений.УдалитьНастройкиТранспортаОбмена.ПредставленияНастроекТранспорта(Объект.ВидТранспортаСообщенийОбмена);
