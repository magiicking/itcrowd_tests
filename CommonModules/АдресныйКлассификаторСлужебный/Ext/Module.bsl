...
Функция СокращенияАдресныхОбъектов(НаименованияАдресныхОбъектов) Экспорт
	...
	ТаблицаАдресныхСокращений = РегистрыСведений._АдресныеОбъекты.АдресныеСокращения();
...
Функция СведенияОЗагрузкеСубъектовРФ() Экспорт
	// ++ БИТ МИС 09022021
	// было
	//Классификатор = РегистрыСведений._АдресныеОбъекты.КлассификаторСубъектовРФ();
	// стало
...
Процедура ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы) Экспорт
	...
	Типы.Добавить(МетаданныеРегистров._ДомаЗданияСтроения);
	...
	Типы.Добавить(МетаданныеРегистров._ИсторияАдресныхОбъектов);
...
Функция СведенияОСубъектахРФ()
	Возврат РегистрыСведений._АдресныеОбъекты.КлассификаторСубъектовРФ();
КонецФункции
...
Процедура ЗагрузитьАдресныеОбъекты(КодСубъектаРФ, КаталогФайлов, ЗагружатьОднимНабором)
	...
	Набор = РегистрыСведений._АдресныеОбъекты.СоздатьНаборЗаписей();
...
Процедура ЗагрузитьДомаЗданияСтроения(КодСубъектаРФ, КаталогФайлов, ЗагружатьОднимНабором)
	...
	Набор = РегистрыСведений._ДомаЗданияСтроения.СоздатьНаборЗаписей();
	Набор.Отбор.КодСубъектаРФ.Установить(КодСубъектаРФ);
...
Процедура ЗагрузитьИсториюАдресныхОбъектов(КодСубъектаРФ, КаталогФайлов, ЗагружатьОднимНабором)
	...
	Набор = РегистрыСведений._ИсторияАдресныхОбъектов.СоздатьНаборЗаписей();
	Набор.Отбор.КодСубъектаРФ.Установить(КодСубъектаРФ);
