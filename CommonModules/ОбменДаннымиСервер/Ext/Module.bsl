...
Функция КоличествоПроблемОбменаДанными(УзлыОбмена = Неопределено)
	...
	ПараметрыПоискаПроблем = РегистрыСведений._РезультатыОбменаДанными.ПараметрыПоискаПроблем();
	...
	Возврат РегистрыСведений._РезультатыОбменаДанными.КоличествоПроблем(ПараметрыПоискаПроблем);
...
Процедура ЗарегистрироватьОшибкуПроведенияДокумента(
	...
	Если РегистрироватьПроблемыВРезультатахОбмена Тогда
		РегистрыСведений._РезультатыОбменаДанными.ЗарегистрироватьОшибкуПроверкиОбъекта(Объект.Ссылка, УзелОбмена,
...
Процедура ПриЗаполненииСпискаТекущихДелПредупрежденияСинхронизации(ТекущиеДела)
	...
	Если Не ПравоДоступа("Просмотр", Метаданные.РегистрыСведений._РезультатыОбменаДанными)
